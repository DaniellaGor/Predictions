...
public class Decrease extends Actions{

    private String expression;
    private String propertyName;

    public Decrease(String givenEntityName, String secondaryEntity, Selection selection, String givenExpression, String propertyGivenName){
        super(givenEntityName,secondaryEntity, "Decrease", selection);
    ...
    void applyActionOnFloat(ContextImpl context, EntityInstanceImpl currentEntity, Object expressionCheckedValue){
        ...
        if(expressionCheckedValue instanceof String){
            if(!((Float.parseFloat(expression) - propertyValue) > topRange ||
                    (Double.parseDouble(expression) - propertyValue) < bottomRange))
